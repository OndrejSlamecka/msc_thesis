...
of Markov Decision Processes},
    ...
    abstract      = {We explore how Monte Carlo tree search type algorithms can be
        used for verification of Markov decision processes (with
        ...
        one of the algorithms performs almost as well as BRTDP on most
        standard models, but it is faster on models where BRTDP
    ...
    My research was supported through project MUNI/C/1367/2015.},
    bib           = {thesis.bib}
}
