...
The solution to the first issue is the {\em interval iteration} algorithm.
TODO

Mention Interval Iteration.
...
We will explore solutions to the second issue later with heuristic
methods.
