...
\noindent {\bf Completness of information about an MDP.}
...
reward maximization and we can use his proof with a simple
reduction \parencite{verification_complexity}.
...
and then transitions only into a new sink state (with reward 0).
...
alternating between simulation and update phases until it has sufficiently
good knowledge about $V(s_0)$. In the simulation phase the algorithm
