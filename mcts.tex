...
estimate of the actual attainable reward.
...
For a precise understanding of the model of games, we present the following
...
rollouts and the algorithm proceeds to the parts of the tree which
either seem to lead victory or which are insufficiently explored, the
